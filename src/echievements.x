...
static unsigned int Echievement_Goals[] =
{
   ...
   [ECH(WINDOW_MOVER)] = 50,
   [ECH(WINDOW_OCD)] = 200,
   [ECH(MOUSE_RUNNER)] = 100000,
   [ECH(MOUSE_MARATHONER)] = 250000,
   [ECH(MOUSE_HERO)] = 1000000,
...
static const char *const Echievement_Descs[] =
{
   ...
   [ECH(MOUSE_RUNNER)] = "Mouse over 100,000 pixels",
   [ECH(MOUSE_MARATHONER)] = "Mouse over 250,000 pixels",
   [ECH(MOUSE_HERO)] = "Mouse over 1,000,000 pixels",
